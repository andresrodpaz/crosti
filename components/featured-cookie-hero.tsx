...
function FeaturedCookieSkeleton() {
  return (
    <section className="w-full">
      <div className="grid grid-cols-1 sm:grid-cols-2 w-full h-[80vh]">
        <div className="w-full h-full bg-[#e8ddd6] animate-pulse" />
        <div className="flex flex-col justify-center px-8 gap-4 bg-[#f7efe8]">
...
export function FeaturedCookieHero() {
  ...
  return (
    <section className="w-full relative">
      <div className="
        grid w-full
        grid-cols-1 h-[100vw] max-h-[600px]
      ...
      ">
        ...
        {/* ── Izquierda: imagen ── */}
        <div className="relative w-full h-full overflow-hidden group bg-[#f7efe8]">
          {imageUrl ? (
            <img
              src={imageUrl}
              alt={cookie.name}
